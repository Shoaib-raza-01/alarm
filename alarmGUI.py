...
def add_alarm_function():
    ...
    messagebox.showinfo("Info",f"Your alaram has been added at time {alarm_time}")
...
set_alarm_frame.place(relx=0.1,rely=0.2,width=400,height=200)

set_alarm_heading = Label(set_alarm_frame, text= "Select Alarm", font =("Oblique",24),background='#0D1C2F',fg="white")
set_alarm_heading.place(relx=0.2,rely=0.2)

hour_value = IntVar()
hour_label = Label(set_alarm_frame, text = "Hour : " , font =("oblique",12),bg='#FF6F69',fg='white')
...
min_value = IntVar()
min_label = Label(set_alarm_frame, text = "Min : " , font =("oblique",12),bg='#FF6F69',fg='white')
...
sec_value = IntVar()
sec_label = Label(set_alarm_frame, text = "Sec : " , font =("oblique",12),bg='#FF6F69',fg='white')
...
submit = Button(set_alarm_frame, text= "Add Alarm",command =add_alarm_function,bg='#0D1C25',fg='white')
submit.place(relx=0.4,rely=0.8)



current_time_frame  = Frame(clock,bg='#FF6F69')
current_time_frame.place(relx=0.6,rely = 0.2,width= 300, height=200)

current_time_heading = Label(current_time_frame, text= "Current Time", font =("oblique",18),background='#0D1C25',fg='white')
current_time_heading.place(relx=0.3,rely=0.2)
...
time_label = Label(current_time_frame,text= curr_time, font =("oblique",24),bg='#0D1C25')
